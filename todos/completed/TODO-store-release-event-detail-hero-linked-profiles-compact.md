...
- The stale active-lane `Next exact step` still referenced opening a PR, but that repository promotion has already happened. Any remaining matrix wording is historical evidence rather than an active blocker.
