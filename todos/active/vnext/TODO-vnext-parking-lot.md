...
- **Authenticated account workspace delivery (event management, memberships/team management, invite metrics dashboards)**
  - Source reference: `foundation_documentation/policies/web_to_app_promotion_policy.md` plus `foundation_documentation/todos/completed/TODO-store-release-web-to-app-conversion-gate.md`.
...
- **Physical check-in + `action_type=check_in` auth-wall telemetry**
  - Source references: `foundation_documentation/policies/web_to_app_promotion_policy.md`, `foundation_documentation/todos/completed/TODO-store-release-web-to-app-conversion-gate.md`, and `foundation_documentation/todos/active/vnext/TODO-vnext-event-checkin.md`.
