...
class SyncFavoriteAccountProfileTopicMembershipJob implements ShouldQueue
{
    ...
    public function __construct(
        ...
        private readonly string $accountProfileId,
    ) {
        $this->afterCommit();
    }
    ...
    public function handle(
        ...
        $tenantContext->runForTenantSlug($this->tenantSlug, function () use ($memberships): void {
            $memberships->syncUserFavoriteProfileMembership($this->userId, $this->accountProfileId);
        });
    }
}
