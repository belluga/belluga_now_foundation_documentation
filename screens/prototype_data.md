...
- **Contratos/Parâmetros:**
  ...
  - Contatos importados: `POST /api/v1/contacts/import` recebe lista de hashes + sal, nunca PII; matching é a via de aquisição canônica para compor `Contatos` e inviteables in-app antes do envio de convites.
