...
| `/contacts/inviteables` | GET | Fetches the backend-computed unified in-app inviteable list for `/convites/compartilhar`, deduplicated by `receiver_account_profile_id` and carrying relation reasons/exposure. | Tenant | n/a | `InviteableContactsResponse` |
