...
| `TODO-store-release-event-occurrence-transactional-consistency-and-reconcile-removal.md` | Remove periodic occurrence reconcile and make aggregate consistency transaction-owned | In progress | Sections 4, 5, 6 | Blocks final multi-occurrence acceptance until occurrence-scoped data is protected by canonical transaction-owned writes and the periodic reconcile scheduler is removed. |
