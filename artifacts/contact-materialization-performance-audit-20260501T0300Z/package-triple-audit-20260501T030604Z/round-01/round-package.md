...
- **Authoritative:** `false`
- **Round:** `01`
- **Base package:** `/home/elton/Dev/repos/belluga-ecosystem/belluga_now_docker/foundation_documentation/artifacts/contact-materialization-performance-audit-20260501T0300Z/package.md`
...
- `lib/infrastructure/repositories/invites_repository.dart`
  ...
  - Skips unchanged fresh full-hash imports for the current viewer/region.
...
| Flutter local contact import cache | `/convites/compartilhar` controller | Normal opens avoid device reload and unchanged full-hash repost; explicit refresh rescans/reimports. | `contacts_repository_test.dart`, `invites_repository_test.dart`, invite share controller tests. | Implemented + tested |
