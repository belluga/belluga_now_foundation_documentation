...
## Goal
Fresh post-second-correction test-quality audit for RR-AUTH-03 after Averroes. Validate stale ambient request-path regression effectiveness, issuer fail-close tests/guardrail evidence, route ability/middleware guardrail assertions, focused suite adequacy, and whether tests can catch the 1552Z regressions. Return JSON only.
