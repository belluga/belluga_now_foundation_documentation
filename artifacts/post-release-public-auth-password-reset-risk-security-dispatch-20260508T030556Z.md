...
## Goal
Security adversarial review for RR-AUTH-04 corrected baseline. Focus on auth/reset/token/rate-limit/multi-tenant abuse paths, use current high-trust guidance, findings first, JSON only.
