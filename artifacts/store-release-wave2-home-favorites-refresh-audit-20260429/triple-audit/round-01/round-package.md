...
| --- | --- | --- |
| Focused favorite regression | `fvm flutter test test/infrastructure/repositories/account_profiles_repository_test.dart --plain-name "toggleFavorite refreshes canonical favorite resumes"` | Passed 2026-04-29 |
