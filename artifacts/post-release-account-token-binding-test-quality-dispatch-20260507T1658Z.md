...
## Goal
Fresh post-runtime-invariant test-quality audit for RR-AUTH-03 after Euclid. Assess whether direct issuer boundary, token account binding, stale ambient context, membership removal, mixed-role read/write asymmetry, route binding, and regression assertions are strong enough for gate closure. Return JSON only.
