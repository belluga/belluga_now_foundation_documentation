...
## Goal
Security adversarial review for RR-AUTH-02. Assess tenant breakout, borrowed token abilities, current-tenant role enforcement, denial non-mutation, app-link trust payloads, and residual route-audit debt. Threat-intel anchors: OWASP Authorization Cheat Sheet and Laravel Sanctum official token ability docs. Return JSON only.
