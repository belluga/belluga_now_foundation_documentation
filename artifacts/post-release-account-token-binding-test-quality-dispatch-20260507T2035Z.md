...
## Goal
Fresh post-20260507T2029Z test-quality audit for RR-AUTH-03. Focus on bypass-prone auth/token regressions, persisted bearer-token event-route coverage, issuer-context negative proof, clean-bounded suite attribution, and whether remaining tests are closure-grade. Return JSON only.
