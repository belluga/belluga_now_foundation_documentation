...
## Goal
Fresh RR-AUTH-04 final review after debt-elimination reopen. Focus on regressions, adherence, residual risk, and whether the bounded slice is truly closure-ready without accepted debt. Findings first. JSON only.
