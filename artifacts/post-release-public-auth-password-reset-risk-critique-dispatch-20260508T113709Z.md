...
## Goal
Final-baseline critique rerun for RR-AUTH-04 after the explicit subject-ceiling correction. Focus on regressions, hidden scope, and whether any blocking critique issue remains on the bounded public-auth/reset/risk package. Findings first, JSON only.
