...
## Goal
Fresh RR-AUTH-04 test-quality audit after debt-elimination reopen. Evaluate fail-first provenance, assertion realism, weak coverage, and CI-evidence sufficiency on the bounded baseline. Findings first. JSON only.
