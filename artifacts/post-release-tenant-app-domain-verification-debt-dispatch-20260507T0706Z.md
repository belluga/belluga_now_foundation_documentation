...
## Goal
Verification-debt audit for RR-AUTH-02. Check TODO/package/checkpoint evidence, matrix completeness, waivers, residual audit exit 2 classification, inline TODO debt in touched files, and whether final CI-equivalent pending is visible rather than hidden. Return JSON only.
