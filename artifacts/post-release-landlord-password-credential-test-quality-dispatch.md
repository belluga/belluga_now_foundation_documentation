...
## Goal
Independent RR-AUTH-01 test-quality audit. Focus on fail-first authenticity, coverage of real split-brain drift, mutation/readback realism, CI-equivalent evidence quality, and whether any assertion gaps still let the landlord credential regression pass unnoticed.
