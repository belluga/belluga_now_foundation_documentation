...
## Goal
Verification-debt audit for RR-AUTH-04 corrected baseline. Focus on closure evidence, waivers, promotion discipline, and inline debt hygiene. Findings first, JSON only.
