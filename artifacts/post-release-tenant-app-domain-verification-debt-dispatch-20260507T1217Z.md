...
## Goal
Verification-debt audit for RR-AUTH-02 after follow-up and final CI-equivalent pass. Check TODO/package/checkpoint evidence, matrix completeness, waivers, residual audit exit 2 classification, inline TODO debt in touched files, and whether final CI evidence is visible. Return JSON only.
