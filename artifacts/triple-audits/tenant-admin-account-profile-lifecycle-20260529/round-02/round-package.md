...
- **Authoritative:** `false`
- **Round:** `02`
- **Base package:** `/home/elton/Dev/repos/belluga-ecosystem/belluga_now_docker/foundation_documentation/artifacts/tenant-admin-account-profile-lifecycle-critique-package-20260529-round02.md`
...
- relation checks either prove no non-test business/public data risk or skip with an auditable unsupported/ambiguous reason.
...
- Direct `forceDelete()` last active/restorable profile rejection test.
