...
## Goal
Final-baseline test-quality rerun for RR-AUTH-04 after the explicit subject-ceiling correction. Focus on assertion realism, regression coverage sufficiency, and whether only the historical fail-first provenance debt remains. Findings first, JSON only.
