...
## Goal
Post-correction security adversarial review for RR-AUTH-03 after Poincare. Assess account/tenant breakout, explicit/current inaccessible account_id issuer path, no-current-account login behavior, push data/actions ability enforcement, bearer-token ceiling abuse, role/membership revocation, and residual route-binding debt. Return JSON only.
