...
## Goal
Fresh post-runtime-invariant security adversarial review for RR-AUTH-03 after Euclid. Focus on account/tenant breakout, direct AccountUser createToken runtime bypass, validated issuer context integrity, token account binding, account route middleware/resource guardrails, stale ambient Account::current semantics, membership/mixed-role revocation, and residual package-side issuer risk. Return JSON only.
