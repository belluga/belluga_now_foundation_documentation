...
## Goal
Post-correction verification debt audit for RR-AUTH-03. Check 1521Z finding resolution, Poincare validation evidence, TODO/package/checkpoint/plan consistency, blocked legacy batch handling, full-suite dirty-tree attribution, waivers, closure drift, and inline TODO debt. Return JSON only.
